...
public sealed class DownloadingDownloadStateTests : BaseTestDownloadState<DownloadingDownloadState>
{
    ...
    [Fact]
    public void Cancel_InThisState_ShouldSucceed()
    {
    ...
    [Fact]
    public async Task Download_WithSimulatedFailure_ShouldFailAndTransitionToErrorState()
    {
        ...
        result.Error.Should().Be(SimulatedFailureMessage);
        context.AssertCurrentStateType<ErrorDownloadState>();
    }
