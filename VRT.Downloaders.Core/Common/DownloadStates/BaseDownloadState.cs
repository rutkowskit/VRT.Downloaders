...
public abstract class BaseDownloadState
{
    ...
    protected static Result<IDownloadContext> EnsureDifferentState(IDownloadContext context, States newState)
    {
    ...
    protected static Result Transition(IDownloadContext context, BaseDownloadState newState)
    {
